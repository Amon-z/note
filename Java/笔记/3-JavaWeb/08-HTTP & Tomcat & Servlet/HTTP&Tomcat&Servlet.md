...
![image-20231206133629275](./assets/image-20231206133629275.png)
...
![image-20231206133652143](./assets/image-20231206133652143.png)
...
* 在日常上网的过程中，我们除了看到这些好看的页面以外，还会碰到很多动态内容，比如我们常见的百度登录效果:
  ![image-20231206133702777](./assets/image-20231206133702777.png)
...
* 数据库主要负责存储数据。
* 整个Web的访问过程就如下图所示:
  ![image-20231206133732242](./assets/image-20231206133732242.png)
...
![image-20231206133826823](./assets/image-20231206133826823.png)
...
![image-20231206164516226](./assets/image-20231206164516226.png)
...
* 请求体: POST请求的最后一部分，存储请求参数
  ...
  ![image-20231206164547790](./assets/image-20231206164547790.png)
...
![image-20231206164624857](./assets/image-20231206164624857.png)
...
![image-20231206164723346](./assets/image-20231206164723346.png)
...
![image-20231206164735264](./assets/image-20231206164735264.png)
...
![image-20231206164831547](./assets/image-20231206164831547.png)
...
* 打开`apache-tomcat-8.5.68`目录就能看到如下目录结构，每个目录中包含的内容需要认识下,
  ...
  ![image-20231206164826387](./assets/image-20231206164826387.png)
...
![image-20231206164907958](./assets/image-20231206164907958.png)
...
![image-20231206165023459](./assets/image-20231206165023459.png)
...
* Tomcat的端口号取值范围是0-65535之间任意未被占用的端口，如果设置的端口号被占用，启动的时候就会包如下的错误
  ...
  ![image-20231206165050751](./assets/image-20231206165050751.png)
...
* Maven Web项目结构: 开发中的项目
  ...
  ![image-20231206165137722](./assets/image-20231206165137722.png)

* 开发完成部署的Web项目

  ![image-20231206165143582](./assets/image-20231206165143582.png)
...
1. 创建Maven项目
   ...
   ![image-20231206165220980](./assets/image-20231206165220980.png)

2. 选择使用Web项目骨架

   ![image-20231206165225229](./assets/image-20231206165225229.png)

3. 输入Maven项目坐标创建项目

   ![image-20231206165229913](./assets/image-20231206165229913.png)

4. 确认Maven相关的配置信息后，完成项目创建

   ![image-20231206165235577](./assets/image-20231206165235577.png)

5. 删除pom.xml中多余内容，只留下面的这些内容，注意打包方式 jar和war的区别

   ![image-20231206165240954](./assets/image-20231206165240954.png)

6. 补齐Maven Web项目缺失的目录结构，默认没有java和resources目录，需要手动完成创建补齐，最终的目录结果如下

   ![image-20231206165246361](./assets/image-20231206165246361.png)
...
1. 创建Maven项目
   ...
   ![image-20231206165258235](./assets/image-20231206165258235.png)

2. 选择不使用Web项目骨架

   ![image-20231206165302885](./assets/image-20231206165302885.png)

3. 输入Maven项目坐标创建项目

   ![image-20231206165322875](./assets/image-20231206165322875.png)

4. 在pom.xml设置打包方式为war,默认是不写代表打包方式为jar

   ![image-20231206165329296](./assets/image-20231206165329296.png)

5. 补齐Maven Web项目缺失webapp的目录结构

   ![image-20231206165333531](./assets/image-20231206165333531.png)

6. 补齐Maven Web项目缺失WEB-INF/web.xml的目录结构

   ![image-20231206165338295](./assets/image-20231206165338295.png)

7. 补充完后，最终的项目结构如下:

   ![image-20231206165344001](./assets/image-20231206165344001.png)
...
![image-20231206165357325](./assets/image-20231206165357325.png)

> 3.掌握不使用骨架的方式创建Maven Web项目

![image-20231206165401984](./assets/image-20231206165401984.png)
...
![image-20231206165535928](./assets/image-20231206165535928.png)
...
![image-20231206165635674](./assets/image-20231206165635674.png)
...
* Servlet是JavaEE规范之一，其实就是一个接口，将来我们需要定义Servlet类实现Servlet接口，并由web服务器运行Servlet
  ...
  ![image-20231206171524786](./assets/image-20231206171524786.png)
...
![image-20231206171549385](./assets/image-20231206171549385.png)
...
![image-20231206172041888](./assets/image-20231206172041888.png)
...
* 一个Servlet,可以配置多个urlPattern
  ...
  ![image-20231206174103043](./assets/image-20231206174103043.png)
...
* ==urlPattern配置规则==
  ...
  * 精确匹配
    ...
    ![image-20231206174123952](./assets/image-20231206174123952.png)
  ...
  * 目录匹配
    ...
    ![image-20231206174156364](./assets/image-20231206174156364.png)
  ...
  * 扩展名匹配
    ...
    ![image-20231206174228638](./assets/image-20231206174228638.png)
    ...
    ![image-20231206174323534](./assets/image-20231206174323534.png)

    2. 如果路径配置的是`*.do`,那么在*.do的前面不能加`/`,否则会报错

    ![image-20231206174336397](./assets/image-20231206174336397.png)

  * 任意匹配

    ![image-20231206174346292](./assets/image-20231206174346292.png)
